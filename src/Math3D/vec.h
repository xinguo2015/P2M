...
namespace xglm {
	...
	public:
		...
		////////////////////////////////////////////////////////
		// dot product
		T dot(const Vec2<T> & b) const										{  return V2_DOT(*this,b); }
		...
		// dot product
		friend T dot ( const Vec2<T> & a, const Vec2<T> & b)				{  return V2_DOT(a,b); }
		friend T length(const Vec2<T> & a)									{  return T(sqrt(dot(a,a))); }
		friend T square_length(const Vec2<T> & a)							{  return dot(a,a); }
		// normalize
		friend Vec2<T> normalize ( const Vec2<T> & a )						{  T len = length(a); return( len==0 ? a : a/len ); }
		// min/max
	...
	public:
		...
		////////////////////////////////////////////////////////
		// dot product
		T dot(const Vec3<T> & b) const										{  return V3_DOT(*this,b); }
		// cross product
		...
		// dot product
		friend T dot ( const Vec3<T> & a, const Vec3<T> & b)				{  return a.dot(b); }
		friend T length(const Vec3<T> & a)									{  return T(sqrt(a.dot(a))); }
		friend T square_length(const Vec3<T> & a)							{  return a.dot(a); }
		// normalize
		friend Vec3<T>  normalize ( const Vec3<T> & a )						{  T len = length(a); return( len==0 ? a : a/len ); }
		Vec3<T>&        normalize ()										{  T len = length(*this); if(len>0) *this /= len; return(*this); }
		// min/max
	...
	public:
		...
		////////////////////////////////////////////////////////
		// dot product
		T dot(const Vec4<T> & b) const										{  return V4_DOT(*this,b); }
		// scalar multiply assign
		...
		// dot product
		friend T dot( const Vec4<T> & a, const Vec4<T> & b)					{  return V4_DOT(a,b); }
		// length
		friend T length(const Vec4<T> & a)									{  return T(sqrt(dot(a,a))); }
		friend T square_length(const Vec4<T> & a)							{  return dot(a,a); }
		// normalize
		friend Vec4<T> normalize ( const Vec4<T> & a )						{  T len = length(a); return( len==0 ? a : a/len ); }
		// min/max
